		...
		<center>
			<form action="AddProceedings">
				<table>
					...
					<tr>
						<td>Conference Chair-Id:</td>
						<td><input type="text" name="authorId"></td>
					</tr>
					<tr>
						<td>Conference Chair-Name:</td>
						<td><input type="text" name="authorName"></td>
					</tr>
					<tr>
						<td>Conference Location:</td>
						<td><input type="text" name="conferenceLocation"></td>
					</tr>
					<tr>
						<td>Conference Date:</td>
						<td><input type="Date" name="conferenceDate"></td>
					</tr>
					<tr>
						<td>Conference Editor-Id:</td>
						<td><input type="text" name="editorId"></td>
					</tr>
					<tr>
